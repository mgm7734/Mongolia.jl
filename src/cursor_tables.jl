using Mongoc, Tables, DataFrames
...
Tables.istable(::Mongoc.Cursor) = true

Tables.rowaccess(::Mongoc.Cursor) = true

Tables.rows(c::Mongoc.Cursor) = FlatteningDictIterator(c)
